...
# This appears to be correct and works for plotting shorter ranges

plotting.figure_plotting_time_interval(Data_frame, 
                                       'Datetime',
                                       'Voltage', 
                                       'Date and time [days/months/years hours/seconds]',
                                       'Voltage',
                                       Date = True, 
                                       start = '01-01-2007',
                                       end = '02-01-2007')
...
# I think I've achieved my objective here. 
